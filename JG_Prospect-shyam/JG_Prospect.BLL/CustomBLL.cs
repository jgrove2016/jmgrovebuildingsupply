...
namespace JG_Prospect.BLL
{
    public class CustomBLL
    {
        ...
        public int UpdateForemanPermissionOfCustomMaterialList(string jobid, char permissionStatus, string FormanEmail)//, int productTypeId, int estimateId)
        {
            return CustomDAL.Instance.UpdateForemanPermissionOfCustomMaterialList(jobid, permissionStatus, FormanEmail);//, productTypeId, estimateId);
        }
