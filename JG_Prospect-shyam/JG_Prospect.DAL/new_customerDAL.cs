...
namespace JG_Prospect.DAL
{
    public class new_customerDAL
    {
        ...
        public int AddCustomerFollowUp(int customerid, DateTime meetingdate, string Status, int userId, bool IsNotes, int assignuserid,string TempFileName)
        {
            int result = 0;
            try
            {
                SqlDatabase database = MSSQLDataBase.Instance.GetDefaultDatabase();
                {
                    ...
                    database.AddInParameter(command, "@EstimateId", DbType.Int32, null);
