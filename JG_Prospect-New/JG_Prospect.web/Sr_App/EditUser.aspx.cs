...
namespace JG_Prospect
{
    public partial class EditUser : System.Web.UI.Page
    {
        ...
        private void binddata()
        {
            ...
            ddlAddedOn.DataSource = (from ptrade in DS.Tables[0].AsEnumerable()
                                     // where !string.IsNullOrEmpty(ptrade.Field<string>("CreatedDateTime"))
                                     select Convert.ToString(ptrade["CreatedDateTime"].ToString())).Distinct().ToList();
            ddlAddedOn.DataBind();
            ddlAddedOn.Items.Insert(0, "--Select--");

            ddlAddedBy.DataSource = (from ptrade in DS.Tables[0].AsEnumerable()
                                     where !string.IsNullOrEmpty(ptrade.Field<string>("AddedBy"))
                                     select Convert.ToString(ptrade["AddedBy"])).Distinct().ToList();
            ddlAddedBy.DataBind();
            ddlAddedBy.Items.Insert(0, "--Select--");
        ...
        private void BindGrid()
        {
            ...
            if (ddlUserStatus.SelectedIndex != 0 || ddlDesignation.SelectedIndex != 0 || ddlAddedOn.SelectedIndex != 0 || ddlAddedBy.SelectedIndex != 0 || ddlSource.SelectedIndex != 0)
            {
                ...
                query = from userdata in dt.AsEnumerable()
                        ...
                        && (userdata.Field<string>("Designation") == ddlDesignation.SelectedItem.Text || ddlDesignation.SelectedIndex == 0)
                         && (userdata.Field<string>("AddedBy") == ddlAddedBy.SelectedItem.Text || ddlAddedBy.SelectedIndex == 0)
                          && (userdata.Field<string>("Source") == ddlSource.SelectedItem.Text || ddlSource.SelectedIndex == 0)
                        && (userdata.Field<DateTime>("CreatedDateTime").ToString() == ddlAddedOn.SelectedItem.Text || ddlAddedOn.SelectedIndex == 0)
                        select userdata;
                if (query.Count() > 0)
                {
