...
{
    public partial class dropzoneimageupload : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string RemoveLocationPic(string serverfilename)
        {
            var originalDirectory = new DirectoryInfo(HttpContext.Current.Server.MapPath("~/CustomerDocs/LocationPics"));
