    ...
    <div class="right_panel">
        ...
        <div class="form_panel">
            ...
            <div id="divTest">
                ...
                <asp:Label ID="lblAddedOn" Text="Added On" runat="server" />
                <asp:DropDownList ID="ddlAddedOn" runat="server" Width="140px" OnSelectedIndexChanged="ddlFilter_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                <asp:Label ID="lblAddedBy" Text="Added By" runat="server" />
                <asp:DropDownList ID="ddlAddedBy" runat="server" Width="140px" OnSelectedIndexChanged="ddlFilter_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                <asp:Label ID="lblSource" Text="Source" runat="server" />
