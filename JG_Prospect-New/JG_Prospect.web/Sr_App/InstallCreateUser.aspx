<%@ Page Title="" Language="C#" MasterPageFile="~/Sr_App/SR_app.Master" AutoEventWireup="true"
    MaintainScrollPositionOnPostback="false" CodeBehind="InstallCreateUser.aspx.cs" EnableEventValidation="false"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="right_panel">
        ...
        <div class="form_panel_custom">
                    ...
                    <li style="width: 49%;">
                        <%--<asp:UpdatePanel ID="UpdatePanel22" runat="server">
                            ...
                            <ContentTemplate>
                                        ...
                                        <tr>
                                            <td>
                                                Would you be able to pass a drug test, background check?
                                                        <br />
                                                <br />
                            ...
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="pnlNew" runat="server">
                                    <table id="table5" class="auto-style14">
                                        ...
                                        <tr>
                                            <td class="auto-style17">
                                                Do you have a warranty/<span>guarantee </span>policy?(Y/N)<br />
                                    ...
                                    <br />
                                        ...
                                        <tr>
                                            <td class="auto-style17">
                                                If yes, what time frame does it cover (years)?<br />
                                        ...
                                        <tr>
                                            <td class="auto-style17">
                                                Is your company a Minority Business Enterprise?<br />
                                    ...
                                    <br />
                                            ...
                                            <td>
                                                Is your company a Women's Business Enterprise?<br />
            ...
            <ul style="margin-bottom: 10px;">
                <li style="width: 49%;">
                    <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:DropDownList ID="ddlInstallerType" runat="server" Width="252px" TabIndex="215">
                                            <asp:ListItem Text="Labor" Value="Labor" Selected="True"></asp:ListItem>
                        ...
                        <tr>
                            <td>
                                <asp:UpdatePanel ID="upnlEmail" runat="server">
                                    <ContentTemplate>
                        ...
                        <tr>
                            <td>
                                <asp:UpdatePanel ID="upnlZip" runat="server">
                                    <ContentTemplate>
                                        <label>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rqState" runat="server" ControlToValidate="txtState"
                                    Display="Dynamic" ForeColor="Blue" ValidationGroup="submit">Enter State</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td class="style1">
                                <asp:UpdatePanel ID="upnl1" runat="server">
                                    ...
                                    User Status</asp:Label><span>*</span></label>
                                        <asp:DropDownList ID="ddlstatus" runat="server" AutoPostBack="true" Width="249px" TabIndex="214" OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged">
                        ...
                        <tr>
                            <td class="style1">
                                ...
                                <asp:TextBox ID="txtlastname" runat="server" MaxLength="40" TabIndex="221" onkeypress="return lettersOnly(event);" autocomplete="off"
                                    OnTextChanged="txtlastname_TextChanged" Width="242px"></asp:TextBox>
                                <br />
                                <label>
                                </label>
                        ...
                        <tr>
                            <td class="style1">
                               ...
                               <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlSource" InitialValue="0"
                                    ForeColor="Green" Display="Dynamic" ValidationGroup="submit">Select Source</asp:RequiredFieldValidator>--%>


                                <%--<asp:TextBox ID="txtSource" runat="server" MaxLength="40" TabIndex="108" autocomplete="off" Width="250px"></asp:TextBox>--%>
                                <br />
                                <label></label>
                                <asp:TextBox ID="txtSource" runat="server" Width="173px" TabIndex="224"></asp:TextBox>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlSource"
                                    ForeColor="Green" Display="Dynamic" ValidationGroup="submit" ErrorMessage="Select Source" InitialValue="Select Source"></asp:RequiredFieldValidator>
                                ...
                                <%--<asp:RequiredFieldValidator ID="rqSourceSubmit" runat="server" ControlToValidate="ddlSource" InitialValue="0"
                            ...
                            <td class="style2">
                                <asp:UpdatePanel ID="upnlCPass" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:TextBox ID="txtpassword1" runat="server" TextMode="Password" autocomplete="off"
                                            MaxLength="30" TabIndex="124" EnableViewState="false" AutoCompleteType="None" Width="242px"></asp:TextBox>
                                        <br />
                                        <label>
                                        </label>
                                        <asp:CompareValidator ID="password" runat="server" ControlToValidate="txtpassword1"
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rqPhone" runat="server" ControlToValidate="txtPhone"
                                    ForeColor="Green" Display="Dynamic" ValidationGroup="submit">Enter Phone No</asp:RequiredFieldValidator>
                            </td>

                        </tr>
                        <tr>
                            <td class="style2">
                                <asp:UpdatePanel ID="upnlSSN" runat="server">
                                    <ContentTemplate>
                        ...
                        <tr>
                            <td class="style2">
                               <%-- <asp:UpdatePanel ID="upnlDOB" runat="server">
                                    <ContentTemplate>--%>
                                       <%-- <label>
                                            Date of Birth<span><asp:Label ID="lblReqDOB" runat="server" Text="*" ForeColor="Red"></asp:Label></span>
                                        </label>--%>

                                        <label>
                                           Date of Birth<span> <asp:Label ID="lblReqDOB" runat="server" ForeColor="Black">
                                            </asp:Label>*</span>
            ...
            <div class="btn_sec">
                <asp:LinkButton ID="lnkSubmit" runat="server" Text="Create User" OnClick="btncreate_Click" TabIndex="209" ValidationGroup="submit">
                    
                </asp:LinkButton>
                <%--<asp:Image ID="imgSubmit" runat="server" ImageUrl="~/Sr_App/img/SubmitButton.png" />--%>
                <%--<asp:Button ID="btncreate" Text="Create User" runat="server" OnClick="btncreate_Click" TabIndex="209" ValidationGroup="submit" />--%>
                <asp:Button ID="btnreset" Text="Reset" runat="server" OnClick="btnreset_Click" TabIndex="210" />
                <asp:Button ID="btnUpdate" Text="Update" runat="server" TabIndex="211" 
                    OnClick="btnUpdate_Click" /><%-- ValidationGroup="submit"--%>
            </div>
        </div>
                ...
                <table width="100%" style="border: Solid 3px #b04547; width: 100%; height: 100%"
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            Email or Phone number already exists,do you want to update the existing record?
                        </td>
                    </tr>
                    <tr>
        ...
        <asp:Panel ID="panel6" runat="server">
            <div id="divPSlite" class="white_content">
                ...
                <table width="100%" style="border: Solid 3px #b04547; width: 100%; height: 100%"
                    ...
                    <tr>
                        <td align="left" colspan="2">
                            Do you want to change the status to phone screened?
                        </td>
                    </tr>
                    <tr>
                        <td align="left" colspan="2" style="height: 15px;">
        ...
        <asp:Panel ID="panel5" runat="server">
         <div id="litePassword" class="white_content">  <%--<div id="litePassword" class="left"> --%>
            <h3>Password
                </h3>
